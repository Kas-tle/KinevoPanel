                ...
                <table class="table table-hover align-items-center table-flush">
                      ...
                      <tbody>
                        @foreach ($nodes as $node)
                            <tr>
                                <td class="text-center text-muted left-icon" data-action="ping" data-secret="{{ $node->getDecryptedKey() }}" data-location="{{ $node->scheme }}://{{ $node->fqdn }}:{{ $node->daemonListen }}/api/system"><i class="fas fa-fw fa-sync fa-spin"></i></td>
